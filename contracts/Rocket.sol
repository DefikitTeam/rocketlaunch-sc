    ...
    ReentrancyGuardUpgradeable
{
    ...
    function buy(
        ...
        bool isDepositLottery = numberBatch > batchAvailable;
        ...
        if (batchAvailable > 0) {
            ...
            require(maxAmountETH >= amountBuyInETH, "Insufficient output ETH");
        ...
        if (isDepositLottery) {
            uint256 amountDepositETH = maxAmountETH.sub(amountBuyInETH);
